		...
		do {
			...
			case 3:
				do {
					...
					choice=sc.next();
					if (!choice.equalsIgnoreCase("Xabi")&&!choice.equalsIgnoreCase("Jago")&&!choice.equalsIgnoreCase("Ekaitz")) {
						System.out.println("ERROR. Escriba el nombre de nuevo.");
					}
				} while (!choice.equalsIgnoreCase("Xabi")&&!choice.equalsIgnoreCase("Jago")&&!choice.equalsIgnoreCase("Ekaitz"));
				for (int i=0;i<a.length;i++) {
